...
public class LinkedList<V>
{
    ...
    public void insertAt(V value, int index)
    {
        ...
        if (0 != index) // I was taught to reverse so if I just put = it will flag me first
        {
            ...
            Node<V> parentNode =
                this.head; //Initially it starts with the 1st node in LL and stuffs it's head value into var parentNode
            Node<V> nextNode =
                this.head.getNext(); // "" takes the ".next" value of parentNode and stuffs it into nextNode
            int position = 0;
